# CODING_RULES.md - Development Guidelines for Coding Agents

<div dir="rtl">

## 📖 نظرة عامة

هذا الدليل يحدد القواعد والمعايير التي يجب على جميع المطورين ووكلاء البرمجة اتباعها عند العمل على منصة "النسخة". الالتزام بهذه القواعد يضمن جودة الكود واتساقه وقابليته للصيانة.
