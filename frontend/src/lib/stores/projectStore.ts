...
const projectStore = createStore<ProjectStore>(
  (set, get): ProjectStore => ({
    ...initialState,
        ...
        updateScene: (id: string, updates: Partial<Scene>) => set((state) => ({
        ...
        addShot: (shot: Shot) => set((state) => ({
          shots: [...state.shots, shot],
        })),
        
        updateShot: (id: string, updates: Partial<Shot>) => set((state) => ({
...
export function useProjectStore<T>(selector?: (state: ProjectStore) => T): T extends undefined ? ProjectStore : T {
...
export function getProjectById(id: string): Project | undefined {
  return projectStore.getState().projects.find((project: Project) => project.id === id);
}
...
export function getCharacterById(id: string): Character | undefined {
  return projectStore.getState().characters.find((character: Character) => character.id === id);
}
